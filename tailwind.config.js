...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'h1': ['28px', { lineHeight: '1.3', fontWeight: '800', letterSpacing: '-0.02em' }],
        'h1-mobile': ['24px', { lineHeight: '1.3', fontWeight: '800', letterSpacing: '-0.02em' }],
        'h2': ['22px', { lineHeight: '1.4', fontWeight: '700' }],
        'h2-mobile': ['20px', { lineHeight: '1.4', fontWeight: '700' }],
        'h3': ['18px', { lineHeight: '1.4', fontWeight: '600' }],
        'h3-mobile': ['16px', { lineHeight: '1.4', fontWeight: '600' }],
