...
:::balloon[Manabu]
深夜1時にパワポを直しながら「これ、去年も同じことやったな」と気づいた瞬間が、僕のターニングポイントだった。
:::
...
:::steps
::step[12ヶ月前]
::step[「辞めたい」と初めて明確に思う。パワポのルーティン化に気づく。]
::step[9ヶ月前]
::step[転職エージェントに登録。市場価値を確認する目的で3社に相談。]
::step[6ヶ月前]
::step[フリーランスという選択肢を本格検討。貯蓄と生活費を計算。]
::step[3ヶ月前]
::step[上司に退職を伝える。プロジェクトの切れ目で。]
::step[退職日]
::step[最終出社。意外とあっさり。知人経由で最初の案件を獲得。]
:::
...
:::point[辞めてわかったこと]
会社の看板は捨てたが、スキルは持ち出せる。
コンサルで培った構造化思考、キャッチアップ力、資料作成力は
独立後にそのまま武器になった。
:::
...
<a href="https://px.a8.net/xxx" rel="sponsored noopener" target="_blank">JACリクルートメント</a>のようなハイクラス特化のエージェントであれば、コンサル出身者のキャリアを正しく理解してくれる。転職するかどうかは別として、自分の現在地を知るために使ってみる価値はある。
...
**AI×コンサルのスキルでキャリアを変える** — コンサルのスキルにAIを掛け合わせると、市場価値が大きく変わる。提案だけでなく実装までできるコンサルは非常に少ない。[AIスキルで市場価値がいくら上がるか](/ai-career/consul-ai-market-value/)も参考にしてほしい。
